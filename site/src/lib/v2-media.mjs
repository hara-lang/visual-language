...
export const deliveryFixtureNotice = Object.freeze({
  ...
  summary: "These artifacts demonstrate Hara projection and provenance rules. Product repositories, registries, runtimes and reviewers remain authoritative for the content, revisions, measurements and receipts exported in production."
});
